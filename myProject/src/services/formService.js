const useForm = () => {
  ...
  const validateTerm = (field, validation) => {
    let errors = [];
    const { regex = null, min = 0, max = 1_000_000_000_000, upperCase = null, numMin = 0, numMax = 1_000_000_000_000 } = validation;
  ...
  const inValidateField = (input, errorSpan, validation = {}) => {
